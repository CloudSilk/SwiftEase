...
import { TextWidget, IconWidget, usePrefix, useTheme } from '@swiftease/designable-react'
import * as monaco from 'monaco-editor/esm/vs/editor/editor.api'
import { Tooltip } from 'antd'
import { parseExpression, parse } from '@babel/parser'
import { uid } from '@swiftease/designable-shared'
...
export const AtaliMonacoInput: React.FC<MonacoInputProps> & {
  ...
  ...props
    ...
    const validate = () => {
      if (checkSyntax && realLanguage.current === 'typescript') {
...
AtaliMonacoInput.loader = loader