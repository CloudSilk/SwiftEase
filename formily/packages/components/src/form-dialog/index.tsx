...
export interface IFormDialog {
  ...
  open(props?: IFormProps, submit?: (env: IEnv, values: any) => Promise<boolean>, autoClose?: boolean): Promise<any>
  close(): void
}
...
export function FormDialog(title: any, id: any, renderer?: any): IFormDialog {
  ...
  const formDialog = {
    ...
    open: async (props: IFormProps, submit?: (env: IEnv, values: any) => Promise<boolean>, autoClose?: boolean) => {
            ...
            () => {
              env.form
                ?.submit(async () => {
                  ...
                  const ok = await submit(env, toJS(env.form?.values))
                  if (ok && autoClose) {
                    formDialog.close()
                  }
                })
